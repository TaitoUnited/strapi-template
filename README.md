...
You can also migrate an existing project that does not currently use Taito CLI by running `taito project migrate strapi-template` in your project root folder.
